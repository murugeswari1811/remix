        ...
        <div className="container m-auto px-2 md:px-12 lg:px-7">
            <div className="flex flex-wrap items-center justify-between py-3 gap-6 md:py-4 md:gap-0">
                <div className="w-full px-6 flex justify-between lg:w-max md:px-0">
                    <a href="https://tailus.io/blocks/hero-section" className="flex space-x-2 items-center">
                        <img src="https://static.vecteezy.com/system/resources/previews/007/890/977/original/burger-logo-for-fast-food-business-free-vector.jpg" className="border-2 border-black h-16 w-16 rounded-full" alt="tailus logo" />
                        <span className="text-2xl font-bold text-yellow-900">Burger <span className="text-yellow-700">Spot</span></span>
                    </a>
                ...
                <div className="hidden w-full lg:flex flex-wrap justify-end items-center space-y-6 p-6 rounded-xl bg-white md:space-y-0 md:p-0 md:flex-nowrap md:bg-transparent lg:w-7/12">
                    ...
                    <div className="w-full space-y-2 border-yellow-200 lg:space-y-0 md:w-max lg:border-l">
                        <Link to="/signup"><button type="button" title="Start buying" className="w-full py-3 px-6 text-center rounded-full transition active:bg-yellow-200 focus:bg-yellow-100 sm:w-max">
